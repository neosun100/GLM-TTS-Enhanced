...
異なるテキスト長の包括的なパフォーマンステスト：

| テキスト長 | 生成時間 | ファイルサイズ | リアルタイムレート |
|-----------|---------|--------------|------------------|
| 8文字 | 3.39秒 | 226KB | 2.4倍 |
| 30文字 | 8.97秒 | 670KB | 3.3倍 |
| 60文字 | 10.57秒 | 808KB | 5.7倍 |
| 100文字 | 12.51秒 | 966KB | 8.0倍 |
| 150文字 | 20.66秒 | 1.6MB | 7.3倍 |

**平均リアルタイムレート**：5.3倍（音声時間 / 生成時間）

📄 **完全なパフォーマンスレポート**：詳細な分析、最適化のヒント、ベンチマークについては [PERFORMANCE_REPORT.md](PERFORMANCE_REPORT.md) をご覧ください。
